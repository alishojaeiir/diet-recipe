<?php
add_action( 'add_meta_boxes', 'add_recipes_metaboxes');
add_action( 'save_post', 'diet_save_recipes_meta', 1, 2 );
...
if ( ! function_exists( 'is_recipe_taxonomy' ) ) {
    /**
...
function add_recipes_metaboxes() {
    add_meta_box('diet_recipe_time', __('Cooking Time', 'diet'), 'diet_recipe_time_callback', 'recipe', 'side', 'default');
    add_meta_box('diet_recipe_rating', __('Rating', 'diet'), 'diet_recipe_rating_callback', 'recipe', 'side', 'default');
    add_meta_box('diet_recipe_short_desc', __('Short Description', 'diet'), 'diet_recipe_short_desc_callback', 'recipe');
    add_meta_box('diet_recipe_ingredients', __('Recipe Ingredients', 'diet'), 'diet_recipe_ingredients_callback', 'recipe');
}
